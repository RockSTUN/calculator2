...
var getPol = require('./routes/polynome') //changed
var getLog = require('./routes/logarithm')
var getExp = require('./routes/exponential')
var getPow = require('./routes/power')
//music test
...
//Calculator
app.use('/calculate', getPol)
app.use('/calculate', getLog)
app.use('/calculate', getPow)
app.use('/calculate', getExp)
